...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const subtopicsData = {
        "jhs1": {
            "Diversity of Matter": [
                { name: "Materials 1", url: "./math-jhs/jhs1/number/number-and-numeration-system/modelling-numbers.html" },
                { name: "Living Cells", url: "./math-jhs/jhs1/number/number-and-numeration-system/comparing-numbers.html" }
            ],
            "Cycles": [
                { name: "Earth Science", url: "./math-jhs/jhs1/number/number-operations/multiplying-by-powers-of-10.html" },
                { name: "Life Cycle of Organisms", url: "./math-jhs/jhs1/number/number-operations/using-number-properties.html" },
                { name: "Crop Production", url: "./math-jhs/jhs1/number/number-operations/operations-word-problems.html" },
                { name: "Animal Production", url: "./math-jhs/jhs1/number/number-operations/addition-and-subtraction.html" }
            ],
            "Systems": [
                { name: "The Human Body System", url: "./math-jhs/jhs1/number/fractions-decimals-and-percentages/fractions.html" },
                { name: "The Solar System", url: "./math-jhs/jhs1/number/fractions-decimals-and-percentages/comparing-and-ordering-fractions.html" },
                { name: "The Ecosystem", url: "./math-jhs/jhs1/number/fractions-decimals-and-percentages/addition-and-subtraction-fraction.html" },
                { name: "Farming System", url: "./math-jhs/jhs1/number/fractions-decimals-and-percentages/word-problems-fractions.html" }
            ],
            "Forces and Energy": [
                { name: "Energy", url: "./math-jhs/jhs1/number/ratios-and-proportion/ratios-between-two-quantities.html" },
                { name: "Electricity and Electronics", url: "./math-jhs/jhs1/number/ratios-and-proportion/unit-rate.html" },
                { name: "Energy Conversion and Conservation", url: "./math-jhs/jhs1/number/ratios-and-proportion/tables-of-equivalent-ratios.html" },
                { name: "Force and Motion", url: "./math-jhs/jhs1/number/ratios-and-proportion/proportional-reasoning.html" },
                { name: "Agricultural Tools", url: "./math-jhs/jhs1/number/ratios-and-proportion/percentage-as-rate.html" }
            ],
            "Humans and the Environment": [
                { name: "Waste Management", url: "./math-jhs/jhs1/algebra/patterns-and-relations/extending-given-relations.html" },
                { name: "Human Health", url: "./math-jhs/jhs1/algebra/patterns-and-relations/rule-of-a-relation.html" },
                { name: "Science and Industry", url: "./math-jhs/jhs1/algebra/patterns-and-relations/predicting-subsequent-elements.html" },
                { name: "Climate Change & Green Economy", url: "./math-jhs/jhs1/algebra/patterns-and-relations/predicting-subsequent-elements.html" },
                { name: "Understanding the Environment", url: "./math-jhs/jhs1/algebra/patterns-and-relations/graphs-of-given-relations.html" }
            ]
        },
        "jhs2": {
            "Diversity of Matter": [
